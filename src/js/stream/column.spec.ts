...
describe("StreamColumn", () => {
    ...
    beforeEach(() => {
        ...
        StreamImage.prototype = jasmine.createSpyObj("StreamImage", [
            "getHeight",
            "getHtml",
        ]);
    ...
    describe("When creating a column", () => {
        ...
        describe("without a photo", () => {
            beforeEach(() => {
                target = new StreamColumn(500, configSpy);
            });
            ...
            it("should get random width", () => {
                expect(StreamUtility.getRandomInteger).toHaveBeenCalledWith(
                    10,
                    11
                );
            ...
            it("should create square cluster", () => {
                expect((target as any).squareCluster).toEqual(
                    jasmine.any(Object)
                );
            });
        ...
        describe("with a photo", () => {
            beforeEach(() => {
                target = new StreamColumn(500, configSpy, "ITEM" as any);
            });
    ...
    describe("When generating the column HTML", () => {
        beforeEach(() => {
            ...
            (squareClusterSpy.generateHtml as jasmine.Spy).and.returnValue(
                "SQ"
            );
